...
export const metadata: Metadata = {
  ...
  title: 'MoonAi AI',
  description:
    'The AI advises. Deterministic code enforces the fund controls. MoonAi does real on-chain work on Sui from the terminal, Telegram, or a web console, with every value-moving action gated by policy, simulation, and approval.',
  ...
  openGraph: {
    ...
    siteName: 'moonai',
    locale: 'en_US',
    title: 'MoonAi AI — verifiable autonomy for on-chain treasuries on Sui',
    description:
    ...
    images: [
      {
        ...
        height: 800,
        type: 'image/jpeg',
        alt: 'MoonAi — a policy-aware AI treasury agent on Sui',
      },
    ],
  },
  twitter: {
