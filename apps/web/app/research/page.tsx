...
export const metadata = {
  title: 'Research & writing · moonai',
  description:
    'How moonai thinks about verifiable autonomy — notes on the four-gate write pipeline, keeping AI advisory, Sui-address identity, and policy as code.',
}
...
const FEATURED: Entry = {
  ...
  blurb:
    'The core idea behind moonai — why an autonomous agent should never hold keys, and how four deterministic gates make “wrong model” a non-event for your funds.',
  href: '/safety',
}
...
const ENTRIES: Entry[] = [
  ...
  },
  {
    ...
    blurb: 'Why fund controls live in deterministic code and the on-chain moonai::policy Move package — allowlists, caps, slippage and health-factor floors.',
  ...
  },
  {
    ...
    blurb: 'moonai is open source. Browse the policy spine, the moonai::policy Move package, and the plugin host on GitHub.',
    ...
    <main className="relative min-h-screen bg-[var(--color-cream)] text-[var(--color-ink)]">
      ...
      <div className="mx-auto w-full max-w-[var(--container-wrap)] px-6 pb-24 pt-28 sm:px-8 md:pt-32">
        <header className="flex max-w-[64ch] flex-col gap-4">
          ...
          >
            How moonai thinks about verifiable autonomy.
          </h1>
