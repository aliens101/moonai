...
export const metadata = {
  title: 'docs · moonai',
  description: 'How moonai works, end to end. Install, architecture, the four-gate write pipeline.',
}
    ...
    <article className="min-w-0">
      ...
      <footer className="mt-20 border-t border-[var(--color-border)] pt-8">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-5 text-[13px]">
          <a
            href="https://github.com/rifkyeasy/moonai#readme"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            href="https://github.com/rifkyeasy/moonai/releases"
            target="_blank"
            rel="noreferrer"
            className="font-mono text-[var(--color-ink-2)] transition hover:text-[var(--color-ink)]"
          >
