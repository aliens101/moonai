...
// map that real moonai TG uses. Anything not listed defaults to 🔧.
...
function ChatWallpaper() {
  return (
    ...
    >
      ...
      <rect width="100%" height="100%" fill="url(#moonai-tg-doodle)" />
    </svg>
  )
}

// ─────────── conic-gradient MoonAi avatar ───────────

function MoonAiAvatar({ size = 24 }: { size?: number }) {
  return (
    <div
      style={{
        width: size,
