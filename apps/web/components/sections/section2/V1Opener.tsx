...
const CHAPTERS: Chapter[] = [
  {
    ...
    body: 'A language model is sharp at reading intent and choosing the next move, and weak as a safety boundary. MoonAi keeps it advisory — it interprets your goal, picks tools, and surfaces opportunities, but never holds the final word over your funds.',
  },
  {
    numeral: 'II',
  ...
  return (
    <div className="flex w-full max-w-[480px] flex-col gap-2">
      ...
      <EntryRow tag="CLI" hint="Run your own agent">
        <CommandPill command="bun add -g moonai-ai-agent" />
      </EntryRow>
      <EntryRow tag="SDK" hint="Build agents in code">
        <CommandPill command="bun add moonai-core" />
      </EntryRow>
    </div>
  )
}
