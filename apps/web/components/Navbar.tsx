...
const NAV: NavEntry[] = [
  ...
  },
  {
    ...
    label: 'Developers',
    items: [
      { label: 'Docs', desc: 'What MoonAi is, end to end', href: '/docs' },
      {
        label: 'CLI · npm',
        desc: 'bun add -g moonai-ai-agent',
        href: 'https://www.npmjs.com/package/moonai-ai-agent',
        external: true,
      },
      {
        label: 'GitHub',
  ...
  { label: 'Pricing', href: '/pricing' },
  {
    label: 'More',
    items: [
      { label: 'About', desc: 'The mission behind MoonAi', href: '/about' },
